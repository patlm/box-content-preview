...
import { BoxFile, PreviewOptions } from './types/models';
...
class Preview extends EventEmitter {
    ...
    disabledViewers: { [key: string]: number } = {};

    /** @property {Object} - Current viewer instance */
    viewer: BaseViewer | undefined;
     ...
     */
    getCurrentViewer(): BaseViewer | undefined {
        return this.viewer;
    }
     ...
     */
    getCurrentFile(): BoxFile | undefined {
        return this.file;
    }
     ...
     * @return {void}
     */
    load(fileIdOrFile: string | number | BoxFile): void {
     ...
     * @return {void}
     */
    parseOptions(previewOptions: PreviewOptions): void {
